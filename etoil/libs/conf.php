<?
$anonym_disp_maps=true; // affichage carte aux anonymes (pour le proto, on n'affiche les cartes que si on est identifi�
...
$tbzoomd[]=1113619; // carte h��e
$tbzoomd[]=450000; // jyj
//$tbzoomd[]=300000; // scan 1000
$tbzoomd[]=280000; // scan 1000
$tbzoomd[]=75000; // scan r�ional
