...
$parc_name_fn=$_REQUEST["parcours_id"]."_".strtr($parc_name_fn," éèêàä","_eeeaa"); // nom du fichier sans caract�es �la con
...
if ($_REQUEST['fexpf']=='shp') {
	...
	else die("Export en shp impossible: ne trouve pas l'utilitaire SHP2PGSQL; v�ifier la config avec les constantes PATH2SHP2PGSQL_TEST ou PATH2SHP2PGSQL_PROD dans le fichier setup.php");
...
} else { // par d�aut c'est du CE3 -> TRK
