...
Opérations à réaliser pour un import :<br>
...
<input type="radio" name="actionname" value="majptdepcpie">MAJ Coordonnees point de départ<BR/>
...
if ($_REQUEST[actionname]=="impcpie") {
	...
	while ($row=pg_fetch_assoc($rep)) {
		...
		".$parcours_discp.",
		'".$row[the_geom]."',
		'identifiant SIG CPIE23:".$row[identifian].", classification:".$row[classifica]." ',
		".$srcg_id.",
		'".date('Y-m-d')."',
		'".date('Y-m-d')."',
		1,1
