...
require_once("dl3tree.inc"); // fichier partag�contenant l'objet permettant de g��er des arboresences
...
$where_lei_f="";
	...
	foreach ($_REQUEST as $cle=>$val) { // passe en revue tte les var get
		// la clé est de la forme "c3kGnnnnnnnCnnnnnnnnTnnnnnnnn"
...
if ($bool_disp_lay_LEI && $where_lei_f!="") {
	...
	$i=i;	
	// faudrait fair eune boucle sur les categ de pts pour avoir des pictos différents..
