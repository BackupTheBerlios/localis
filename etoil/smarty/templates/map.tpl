...
<td width="{$sizex+2}" align="center" class="navmap" onclick="document.getElementById('ct').click();"
><input {popup text="{tr}Vers le Nord{/tr}"} id="ct" type="image" src="img/flecheH.gif" border="0" name="dir" value="ct" /></td>
<td width="{$mapmargin}"><input {popup text="{tr}Vers le Nord-Est{/tr}"} type="image" src="img/flecheHD.gif" border="0" name="dir" value="rt" /></td>
</tr><tr>
<td class="navmap" onclick="document.getElementById('lc').click();"
><input id="lc" {popup text="{tr}Vers l'Ouest{/tr}"} type="image" src="img/flecheG.gif" border="0" name="dir" value="lc" /></td>
...
<td class="navmap" onclick="document.getElementById('rc').click();"
><input id="rc" {popup text="{tr}Vers l'Est{/tr}"} type="image" src="img/flecheD.gif" border="0" name="dir" value="rc" /></td>
</tr><tr>
<td><input {popup text="{tr}Vers le Sud-Ouest{/tr}"} type="image" src="img/flecheBG.gif" border="0" name="dir" value="lb" /></td>
<td class="navmap" align="center" onclick="document.getElementById('cb').click();"
><input id="cb" {popup text="{tr}Vers le Sud{/tr}"} type="image" src="img/flecheB.gif" border="0" name="dir" value="cb" /></td>
